...
QT_MOC_LITERAL(3, 40, 11), // "block_width"
QT_MOC_LITERAL(4, 52, 11), // "block_heigh"
QT_MOC_LITERAL(5, 64, 15), // "block_start_num"
QT_MOC_LITERAL(6, 80, 11) // "block_count"

    },
    "StatusWidget\0widget_update_paint_value\0"
    "\0block_width\0block_heigh\0block_start_num\0"
    "block_count"
};
...
void StatusWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->widget_update_paint_value((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        default: ;
        }
    }
}
