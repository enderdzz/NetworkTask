...
public:
    ...
    void setupUi(QMainWindow *Netsim_MainWindow)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(518, 400, 171, 41));
        ...
        spinWindowSize->raise();
        groupDataLength->raise();
        ...
        treeView->setGeometry(QRect(70, 140, 256, 192));
        Netsim_MainWindow->setCentralWidget(centralwidget);
        gridLayoutWidget->raise();
        progressBar->raise();
        widgetConfig->raise();
        groupTransStatus->raise();
